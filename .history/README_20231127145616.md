...
which are ubiquitous in nature[1],[2],[3] . These are non-equilibrium in nature, so
it is very hard to determine the steady states from Gibb’s distribution. These
studies proved worth not just artefact of simulation and mathematical work [1] .
...
gels [6] ,
river
networks [7] , granular materials [8] , traffic flows [9] , etc.
